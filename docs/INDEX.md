...
## 当前里程碑状态速览（2026-09-14，详见 OPEN-PROBLEMS.md）

- M0 ✅（门禁 PASS，哈希门禁在档）。
- M1：T3（SIMD SAT + 体轴缓存）、T4（5.1–5.7× 且逐位一致）、T6（p95 0.166ms）✅；
  T1 首处净正向落地（回退半径 4×skin→1×skin），泵源已定位但未消；
  T2/T3 峰值未达验收线；T5 受 T1 制约。**M2 不得启动**。
